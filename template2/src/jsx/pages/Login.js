        ...
        <div className="login-main-page" style={{backgroundImage:"url("+ loginbg +")"}}>
            <div className="login-wrapper">
                <div className="login-aside-left" style={{backgroundImage:"url("+ login +")"}}>
                    <Link to="/dashboard" className="login-logo d-flex align-items-center text-decoration-none">
                        <img src={logo} alt="WEIC Dash Logo" style={{ maxHeight: "50px", maxWidth: "50px", objectFit: "contain" }} className="me-2"/>
                        <span className="fs-22 font-w700 text-black">WEIC Dash</span>
                    </Link>
                    <div className="login-description">
                        ...
                        <div className="mt-5">
                            ...
                            <Link to={"#"} className="text-black">© 2023 DexignZone</Link>
                        </div>
                    </div>
                </div>
                          ...
                          <div className="row no-gutters">
                            <div className="col-xl-12">
                              <div className="auth-form-1">
                                  <div className="mb-4">
                                      <h3 className="text-white mb-1">Welcome to WEIC Dash</h3>
