                ...
                <div className="mt-4 col-xl-6 col-lg-12 col-md-12 col-sm-12 d-flex justify-content-lg-end justify-content-md-center justify-content-xs-start">
                  <div className="row align-items-center">
                    <div className="col-sm-9">
                      <div className="brand-logo mb-3 d-flex align-items-center">
                        <img className="logo-abbr me-2" src={logo} alt="WEIC Dash" style={{height:'40px', width:'auto', objectFit:'contain'}}  />
                        <span className="fs-20 font-w700 text-black">WEIC Dash</span>
                      </div>
                      <span>
