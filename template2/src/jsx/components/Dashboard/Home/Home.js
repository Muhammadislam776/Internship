...
import pic6 from './../../../../images/card/pic6.jpg';
import pic7 from './../../../../images/card/pic7.jpg';
import pic8 from './../../../../images/card/pic8.jpg';
import pic9 from './../../../../images/card/pic9.jpg';
import pic10 from './../../../../images/card/pic10.jpg';

const menusList = [
	{image: pic8, title:'Chicken curry special with cucumber', number:'1', doller:'5.6', order:'90x'},
	{image: pic4, title:'Watermelon juice with ice', number:'2', doller:'4.8', order:'70x'},
	{image: pic9, title:'Italiano pizza with garlic', number:'3', doller:'12.3', order:'60x'},
	{image: pic6, title:'Tuna soup spinach with himalaya salt', number:'4', doller:'3.6', order:'50x'},
	{image: pic10, title:'Medium Spicy Spagethi Italiano', number:'5', doller:'4.2', order:'40x'},
];
...
const requestData = [
	{id:'#0010235', image:pic2, title:'Tuna Soup spinach with himalaya salt.', name:'Jimmy Kueai', subtitle:'South Corner st41256 london', doller:'7.4', version:'x3', status:'PENDING', change:'bgl-warning text-warning'},
	{id:'#0010299', image:pic3, title:'Mozarella Pizza With Random Topping', name:'Kinda Alexa', subtitle:'Blue Ocean st.41551 London', doller:'8.2', version:'x1', status:'DELIVERED', change:'bgl-success text-success'},
	{id:'#0010235', image:pic7, title:'Sweet Cheezy Pizza for Kids Meal (Small Size)', name:'Peter Parkur', subtitle:'Franklin Avenue St.66125 London', doller:'4.2', version:'x2', status:'CANCELED', change:'bgl-danger text-danger'},
	{id:'#0010237', image:pic1, title:'Tuna soup spinach with himalaya salt', name:'Jimmy Kueai', subtitle:'South Corner st41256 london', doller:'6.5', version:'x4', status:'DELIVERED',change:'bgl-success text-success'},
	{id:'#0010238', image:pic6, title:'Mozarella Pizza With Random Topping', name:'Cindy Alexa', subtitle:'Blue Ocean St.41551 London', doller:'8.9', version:'x5', status:'PENDING', change:'bgl-warning text-warning'},
];
											...
											<td>
												<div className="media align-items-center">												
													<Link to={"/ecom-product-detail"} >	
														<img className=" me-3 img-fluid rounded-circle" width="75" src={item.image} alt="DexignZone" />
													</Link>
													<div className="media-body">
														<h5 className="mt-0 mb-2"><Link to={"/ecom-product-detail"} className="text-black" >{item.title}</Link></h5>
														<p className="mb-0 text-primary">{item.id}</p>
													</div>
												</div>
											</td>
											<td>
												<h5 className="mb-2 text-black wspace-no">{item.name}</h5>
												<p className="mb-0">{item.subtitle}</p>
											</td>
											<td style={{width:"100px"}}>
												<div className="d-flex align-items-center justify-content-center">
													<h4 className="mb-0 me-3 fs-20 text-black d-inline-block">${item.doller}</h4>
													<p className="mb-0 fs-20 d-inline-block">{item.version}</p>
												</div>
											</td>
											<td>
												<div className="d-flex align-items-center">
													<Link to={"#"} className={`btn ${item.change}`} >{item.status}</Link>
													<Dropdown>
														...
														<Dropdown.Menu>
															...
															<Dropdown.Item > 
																<Link to ={"#"} className="text-black" >
																	<svg className="me-3" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
																		<path d="M12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22Z" stroke="#F24242" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path>
																		<path d="M15 9L9 15" stroke="#F24242" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path>
																		<path d="M9 9L15 15" stroke="#F24242" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path>
																	</svg>
																	Reject order
																</Link>
															</Dropdown.Item>	
									...
									<li key={index}>
										<div className="timeline-panel">
											<div className="media me-3">
												<Link to={"/ecom-product-detail"}>	
													<img alt="" width="90" src={item.image} />
												</Link>	
												<div className="number">#{item.number}</div>
											</div>
											<div className="media-body">
												<h5 className="mb-3"><Link to={"/ecom-product-detail"}  className="text-black">{item.title}</Link></h5>
												<div className="d-flex justify-content-between align-items-center">
													<h4 className="mb-0 text-black font-w600">${item.doller}</h4>
													<p className="mb-0">Order <strong className="text-black font-w500">{item.order}</strong></p>
												</div>
											</div>
										</div>
									</li>
