						...
						<div className="">
							<form >
								...
								<div className="modal-footer">
                                    ...
                                    <button type="button" onClick={()=> setPostModal(false)} className="btn btn-danger light"> <i className="flaticon-delete-1"></i> Discard</button>      
								</div>
							</form>
                        ...
                        <div  className="card project-boxed">
                            ...
                            <div className="card-header align-items-start">
                                <div>
                                    ...
                                    <div className="text-dark fs-14 text-nowrap"><i className="fa fa-calendar me-3" aria-hidden="true"></i>Created on Sep 8th, 2020</div>
                                </div>
                                <Dropdown className="">
