...
import pic11 from './../../../../images/card/pic11.jpg';
import pic12 from './../../../../images/card/pic12.jpg';
												...
												<div className="card-body p-1">
													<div className="sp15 row border-bottom favorites-items p-3 align-items-center p-sm-4">
														<div className="col-xl-5 col-lg-5 col-sm-8 col-12 mb-3 mb-lg-0">
															<div className="media align-items-center">
																<Link to={"/ecom-product-detail"}>
																	<img className="rounded me-3" src={require("./../../../../images/card/pic4.jpg")} alt="" width="105" />
																</Link>	
																<div className="media-body">
																	...
																	<Link to={"#"} className="text-primary fs-14 d-flex align-items-center"><i className="fa fa-heart fs-20 me-2" /> <strong className="me-1">256k</strong>Like it</Link>
																</div>
															</div>
														</div>
														<div className="col-xl-3 col-lg-3 col-sm-4 col-12 media align-items-center">
															<div className="">
																{/* Sparkline Chart */} 
																<svg className="me-3" width="100" height="32" >
														...
														<div className="col-xl-2 col-lg-2 col-sm-6 col-6 text-end">
													...
													<div className="sp15 row border-bottom favorites-items p-3 align-items-center p-sm-4">
														<div className="col-xl-5 col-lg-5 col-sm-8 col-12 mb-3 mb-lg-0">
															<div className="media align-items-center">
																<Link to={"/ecom-product-detail"}>
																	<img className="rounded me-3" src={require("./../../../../images/card/pic2.jpg")}alt="" width="105" />
																</Link>
																<div className="media-body">
																	...
																	<Link to={"#"}  className="text-primary fs-14 d-flex align-items-center"><i className="fa fa-heart fs-20 me-2" aria-hidden="true"></i> <strong className="me-1">256k</strong> Like it</Link>
																</div>
															</div>
														</div>
														<div className="col-xl-3 col-lg-3 col-sm-4 col-12 media align-items-center">
													...
													<div className="sp15 row border-bottom favorites-items p-3 align-items-center p-sm-4">
														<div className="col-xl-5 col-lg-5 col-sm-8 col-12 mb-3 mb-lg-0">
															<div className="media align-items-center">
																<Link to={"/ecom-product-detail"}>
																	<img className="rounded me-3" src={require("./../../../../images/card/pic7.jpg")} alt="" width="105" />
																</Link>	
																<div className="media-body">
						...
						<div className="col-lg-8">
							<div className="card">
								<div className="card-header border-0">
									...
									<Dropdown>
										<Dropdown.Toggle  as="button" type="button" className="btn border  btn-rounded text-black" >
											Monthly
										</Dropdown.Toggle>
										<Dropdown.Menu>
							...
							<div className="card">
								...
								<div className="card-body">	
									<div className="media align-items-center mb-4">		
										<Link to={"/app-profile"}>
											<img className="me-3 rounded" src={require("../../../../images/profile/5.jpg")} width="70" alt="" />
										</Link>	
										<div className="media-body">
									...
									<div className="media align-items-center mb-4">	
										<Link to={"/app-profile"} >
											<img className="me-3 rounded" src={require("../../../../images/profile/6.jpg")} width="70" alt="" />
										</Link>	
										<div className="media-body">
									...
									<div className="media align-items-center mb-4">		
										<Link to={"/app-profile"} >
											<img className="me-3 rounded" src={require("../../../../images/profile/7.jpg")} width="70" alt="" />
										</Link>	
										<div className="media-body">
									...
									<div className="media align-items-center">	
										<Link to={"/app-profile"} >
											<img className="me-3 rounded" src={require("../../../../images/profile/10.jpg")} width="70" alt="" />
										</Link>	
										<div className="media-body">
					...
					<div className="row">
											...
											{menusList.map((item, index)=>(
												<li key={index}>
													<div className="timeline-panel">
														...
														<div className="media-body">
															<h5 className="mb-3 text-black"><Link to={"/ecom-product-detail"}  className="text-black">{item.title}</Link></h5>
						...
						<div className="col-xl-12 col-xxl-6 col-md-6">	
							<div className="card">
								...
								{selerBlog.map((item, index)=>(								
									<div className="card-body border-bottom" key={index}>
										<div className="media mb-3">
											<Link to={"/ecom-product-detail"}>
												<img className="rounded" src={item.image} style={{width:"100%" }} alt="" />
											</Link>
										</div>
										<div className="info">
