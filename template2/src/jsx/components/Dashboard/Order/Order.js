...
import pic5 from '../../../../images/card/pic5.jpg';
import pic6 from '../../../../images/card/pic6.jpg';
import pic7 from '../../../../images/card/pic7.jpg';
import SvgImage from '../../../../images/svg/map.svg';

const tableDataBlog = [
	{ image:pic5, title:'Watermelon juice with ice', qty:'1x', price:'4.5', total:'4.5'},
	{ image:pic6, title:'Chicken curry special with cucumber', qty:'3x', price:'6.5', total:'19.5'},
	{ image:pic7, title:'Italiano pizza with garlic', qty:'4x', price:'9.5', total:'38'}
];
			...
			<Fragment>
				...
				<div className="form-head d-flex mb-3 mb-md-5 align-items-start">
					<div className="me-auto d-none d-lg-block">
						...
						<svg className="me-3" width="24" height="12" viewBox="0 0 24 12" fill="none" xmlns="http://www.w3.org/2000/svg">
					...
					<div className="dropdown ms-auto">
						<div className="btn btn-primary btn-rounded dropdown-toggle d-block  px-4" data-toggle="dropdown">
							<svg className="me-2 scale5" width="14" height="14" viewBox="0 0 33 33" fill="none" xmlns="http://www.w3.org/2000/svg">
								...
								<div className="card">
									<div className="card-body">
										<div className="full-map-area">
											<img src={SvgImage} alt="" style={{width:"100%"}} /> 
											<Link to={"#"} >
									...
									<div className="card-body rounded" style={{background:"#3f4953"}}>
										<div className="row mx-0 align-items-center">
											<div className="media align-items-center col-xl-6 col-lg-5 px-0 mb-3 mb-md-0">
												<img className="me-3 img-fluid rounded-circle" width="100" src={require("../../../../images/profile/5.png")} alt="DexignZone" />
											...
											<div className="text-left text-lg-right col-xl-6 col-lg-7 p-0 mt-lg-0 mt-3">
												<div className="iconbox mb-3 me-3 mb-md-0">
												...
												<tbody>
													{tableDataBlog.map((item, ind)=>(
														<tr key={ind}>
															<td>
																<div className="media">
																	<Link to={"/ecom-product-detail"} >
																		<img className="me-3 img-fluid rounded" width="85" src={item.image} alt="DexignZone" />
																	</Link >
																	<div className="media-body">
																		<small className="mt-0 mb-1 font-w500"><Link to={"#"} className="text-primary" >MAIN COURSE</Link ></small>
																		<h5 className="mt-0 mb-2 mb-4"><Link to={"/ecom-product-detail"} className="text-black" >{item.title}</Link ></h5>
															...
															<td>
																<h4 className="my-0 text-secondary font-w600">{item.qty}</h4>
															</td>
															<td>
																<h4 className="my-0 text-secondary font-w600">${item.price}</h4>
															</td>
															<td className="d-md-none d-lg-table-cell">
																<h4 className="my-0 text-secondary font-w600">${item.total}</h4>
															</td>
															<td>
								...
								<div className="card">
									<div className="card-body border-bottom">
										<div className="media align-items-center">
											<img className="me-3 rounded-circle" src={require("../../../../images/profile/6.jpg")} width="90" alt="" />
											<div className="media-body">
									...
									<div className="card-body border-bottom">
										<div className="media align-items-center">
											<svg className="me-4" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
									...
									<div className="card-body border-bottom">
										<div className="media align-items-center">
											<svg className="me-4" width="24" height="24" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg" style={{minWidth: "24px" }}>
