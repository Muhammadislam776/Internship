...
const ForgetPasswordPage = props => {
  ...
  document.title = "Forget Password | WEIC Dash - React Admin & Dashboard Template";
          ...
          <Row className="justify-content-center">
            <Col md={8} lg={6} xl={5}>
                  ...
                  <Row>
                    <Col xs={7}>
                      <div className="text-primary p-4">
                        ...
                        <p>Sign in to continue to WEIC Dash.</p>
                      </div>
                    </Col>
              ...
              <div className="mt-5 text-center">
                ...
                <p>
                  © {new Date().getFullYear()} WEIC Dash. Crafted with{" "}
