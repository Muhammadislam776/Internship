...
const Register = props => {
    document.title = "Register | WEIC Dash - React Admin & Dashboard Template";
                ...
                <Col lg={6} md={8} xl={4}>
                    <Card className='mt-5'>
                        <CardBody className="p-4">
                            ...
                            <p className="text-muted text-center mb-4">Get your free WEIC Dash account now.</p>
                            <Form
                    ...
                    <div className="mt-5 text-center">
                        ...
                        <p className="text-white-50">© {new Date().getFullYear()} WEIC Dash. Crafted with <i className="mdi mdi-heart text-danger"></i> by Themesdesign</p>
                    </div>
                </Col>
            </Row>
        </Container>
