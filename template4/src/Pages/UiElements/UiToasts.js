...
const UiToasts = () => {
  document.title = "Toast | WEIC Dash - React Admin & Dashboard Template";
                  ...
                  <div style={{ minHeight: "110px" }}>
                    <Toast isOpen={toast5}>
                      <ToastHeader toggle={toggleToast5}>
                        <img src={logo} alt="" className="me-2" height="18" />
                        <strong className="me-auto">WEIC Dash</strong>
                        <small
            ...
            <Col xl={12}>
              <Card>
                <CardBody>
                  ...
                  <form>
                    <div className="mb-3">
                      <label htmlFor="selectToastPlacement" className="mt-2">
                        Select a position...
                      </label>
                      <select
                  ...
                  >
                    <div
                      className={`toast-container position-absolute p-3 ${selectedPosition}`}
                      id="toastPlacement"
                    >
                      <Toast>
                        <ToastHeader>
