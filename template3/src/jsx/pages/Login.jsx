      ...
      <div className="login-wrapper">
        <div className="login-aside-left" >
          <Link to="/dashboard" className="login-logo">
            <img src={logo} alt="WEIC Dash Logo" style={{ maxHeight: "70px", maxWidth: "240px", objectFit: "contain", marginBottom: "20px" }} />
          </Link>
          <div className="login-description">
            <h2 className="main-title mb-2">Welcome To WEIC Dash</h2>
